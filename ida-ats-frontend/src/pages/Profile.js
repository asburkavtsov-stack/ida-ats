    ...
    <div style={{ padding: '28px', maxWidth: '600px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '28px' }}>
        <div style={{
          ...
          justifyContent: 'center', color: '#fff', fontWeight: 700, fontSize: '1.4rem',
        }}>
          {initials}
        </div>
        <div>
      ...
      <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '14px', padding: '24px' }}>
        ...
        <div style={{ display: 'grid', gap: '14px', marginBottom: '18px' }}>
          <div>
            ...
            <input type="password" value={passwordForm.new_password} onChange={e => setPasswordForm(f => ({ ...f, new_password: e.target.value }))} style={inputStyle} />
          </div>
          <div>
            <div style={{ fontSize: '0.72rem', color: 'var(--muted)', marginBottom: '6px', fontFamily: 'DM Mono' }}>Підтвердити пароль</div>
            <input type="password" value={passwordForm.confirm_password} onChange={e => setPasswordForm(f => ({ ...f, confirm_password: e.target.value }))} style={inputStyle} />
          </div>
        </div>
