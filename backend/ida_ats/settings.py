...
if _REDIS_URL:
    CHANNEL_LAYERS = {
        'default': {
            ...
            'CONFIG': {
                # hosts як dict — всі extra kwargs передаються в ConnectionPool.from_url().
                # socket_keepalive=True не дає Railway proxy рвати idle TCP-з'єднання.
                # socket_connect_timeout і socket_timeout захищають від зависань.
                'hosts': [{
                    'address': _REDIS_URL,
